...
api_routes = [
    path('detect/', home_views.detect_view, name='detect'),
    ...
    path('api/upload-video/', home_views.upload_video, name='upload_video'),
    path('api/get-frame/', home_views.get_frame, name='get_frame'),
    path('api/stop_detection/', home_views.stop_detection, name='stop_detection'),
    path('api/start-camera', home_views.start_camera),
    path('api/get-latest-frame/', home_views.get_latest_frame, name='get_latest_frame'),
