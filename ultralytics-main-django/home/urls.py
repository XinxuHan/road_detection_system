...
api_routes = [
    ...
    path('api/upload_video/', home_views.upload_video_view, name='upload_video'),
    path('api/get_frame/', home_views.get_frame_view, name='get_frame'),
    path('api/stop_detection/', home_views.stop_recognition_view, name='stop_detection'),
    path('api/start_camera', home_views.start_camera_view),
    path('api/get_latest_frame/', home_views.get_latest_frame_view, name='get_latest_frame'),
    path('api/analyze_llm/', analyze_llm_view, name='analyze_llm'),
]
